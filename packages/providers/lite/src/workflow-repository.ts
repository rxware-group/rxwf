...
export function createLiteWorkflowRepository(db: LiteDatabase): WorkflowRepositoryPort {
  return {
    ...
    async deleteWorkflow(workflowId: string) {
      ...
      await db.delete(versionsTable).where(eq(versionsTable.workflowId, workflowId));
