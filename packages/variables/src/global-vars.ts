import type { GlobalVarSyncInput, GlobalVarItem, VarRecord } from './types.js';

export function groupGlobalVarRecords(records: VarRecord[]): GlobalVarItem[] {
  const byKey = new Map<string, GlobalVarItem>();
...
export function globalVarSyncToUpserts(input: GlobalVarSyncInput): Array<{
